...
@Component({
    ...
    `,
    styles: [
        ".btn-container-passheure {display:flex; position: relative; border:round; width:250px ; height: 40px ;background-color: var(--passheure-orange); border-radius: 25px}",
        ...
        ".btn-container-passheure p {color:white; font-family: 'passheure-title-font'; font-size: 14px}"],
